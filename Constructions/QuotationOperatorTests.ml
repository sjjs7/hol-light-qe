...
let n_notEff = not_free_abs_not_effective `n:num` `\n:num. eval testFun n to epsilon = eval testFun2 n to epsilon` `m:num`;;
addNotEff n_notEff;;

prove(`!n:num. eval testFun n to epsilon = eval testFun2 n to epsilon`,
   INDUCT_TAC THEN
